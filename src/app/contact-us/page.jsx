...
export default async function ContactUs() {
    return (<div className='grid md:justify-center font-accent text-softCoral p-3'>
       <form className='md:grid grid-col-2 gap-x-8 gap-y-5 focus:outline-none md:m-10'>
            ...
            <div>
                ...
                <input type='text' className='bg-softWhite w-full rounded-md shadow block grow p-2' name="username"></input>
            </div>

            <div>
                <label>Email: </label>

                <input type='email' className='bg-softWhite  w-full rounded-md shadow block grow p-2'></input>
