...
export default async function ProductsByTypePage({ params }) {
    const products = await sanityClient.fetch(`*[_type == "product" && productType == $type]{
      _id,
      name,
      slug,
      description,
    ...
    return (<div className="break-normal justify-center p-5">
