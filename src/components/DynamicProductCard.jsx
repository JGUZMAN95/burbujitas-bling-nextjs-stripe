...
export default function DynamicProductCard({ product }) {
    ...
    return (<div className="transition-transform duration-300 m-4">
      <div className="md:grid md:grid-cols-2 gap-10">
        <img src={imageUrl} alt={product.name} className="object-cover w-full h-auto"/>
        ...
        <div>
          ...
          <button onClick={handleAddToCart} disabled={adding} className="mt-2 bg-softCoral text-white px-4 py-2 rounded">
